  ...
  return (
    <>
      <div className="px-4 py-10 md:py-16  md:px-10 text-start">
        ...
        <div className="hidden md:grid mt-16 grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {faqs.map((faq, index) => (
        ...
        <div className="grid md:hidden mt-16 grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {faqsSmallScreen.map((faq, index) => (
            <div key={index} className="md:w-[432px]">
              <p className="mt-3 text-xl text-[#141414]">{faq.title}</p>
              <p className="mt-1 text-[#757575]">{faq.message}</p>
            </div>
      ...
      <div className=" bg-[#EDFAFF] rounded-2xl mb-20 flex flex-col md:flex-row md:justify-between md:mb-40 mx-4 md:mx-10 p-8">
        ...
        <button
          className="mt-6 md:mt-0 btn flex items-center justify-center h-11 px-[18px] rounded-3xl font-medium cursor-pointer"
